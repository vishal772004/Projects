...
--Now we try to find the list of people who may be a suspect by analyzing the withdrawal ,call history and checking the licence plate at the bakery
...
-- Now we try to match the person who booked a flight
SELECT name
FROM people
...
--Finally by nesting both the above queries we get the thief
